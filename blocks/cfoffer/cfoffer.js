...
export default async function decorate(block) {
  const aempublishurl = 'https://publish-p107502-e1212957.adobeaemcloud.com';
  ...
  block.innerHTML = `
    <div class='banner-content'>
        <div class='banner-detail' style="background-image: linear-gradient(90deg,rgba(0,0,0,0.6), rgba(0,0,0,0.1) 80%) ,url(${aempublishurl + cfReq.heroImage._publishUrl});">
